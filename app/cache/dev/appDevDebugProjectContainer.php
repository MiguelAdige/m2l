...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'M2LUserBundle:User', 'pseudo', NULL);
    }
