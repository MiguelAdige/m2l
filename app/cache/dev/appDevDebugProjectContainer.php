...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'm2l', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_a50fb103297b42ef2d904aec0b850968859f1d55d12a870bfa99851a811a8fde');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a50fb103297b42ef2d904aec0b850968859f1d55d12a870bfa99851a811a8fde');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_a50fb103297b42ef2d904aec0b850968859f1d55d12a870bfa99851a811a8fde');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\UserBundle\\Entity', 1 => 'E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\AnnoncesBundle\\Entity', 2 => 'E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\LigueBundle\\Entity', 3 => 'E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\MessagerieBundle\\Entity'));
        ...
        $f->addDriver($e, 'M2L\\MessagerieBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('M2LUserBundle' => 'M2L\\UserBundle\\Entity', 'M2LAnnoncesBundle' => 'M2L\\AnnoncesBundle\\Entity', 'M2LLigueBundle' => 'M2L\\LigueBundle\\Entity', 'MessagerieBundle' => 'M2L\\MessagerieBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('M2L\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('login_path' => '/login', 'default_target_path' => '/', 'use_referer' => true, 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
        $m->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'main', $m, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $k, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '550a8c8499912', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $h, $j, $g), 6 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker'), 'main', $h, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $k, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\UserBundle/Resources/views', 'M2LUser');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\AnnoncesBundle/Resources/views', 'M2LAnnonces');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\LigueBundle/Resources/views', 'M2LLigue');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\MessagerieBundle/Resources/views', 'Messagerie');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/Resources/views');
        $instance->addPath('E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5a5f3a7dcfa75c89c2e86f79b063c863');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
        $instance->addYamlMappings(array(0 => 'E:\\Profil\\Documents\\Dropbox (Mixta)\\Sites\\m2l\\src\\M2L\\UserBundle\\Resources\\config\\validation.yml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'M2LUserBundle:User', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev',
            'kernel.logs_dir' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/logs',
            'kernel.bundles' => array(
                ...
                'MessagerieBundle' => 'M2L\\MessagerieBundle\\MessagerieBundle',
            ...
            'locale' => 'en',
            'secret' => '5a5f3a7dcfa75c89c2e86f79b063c863',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => '5a5f3a7dcfa75c89c2e86f79b063c863',
            ...
            'session.save_path' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/profiler',
            ...
            'router.resource' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/../web',
            'assetic.write_to' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'E:/Profil/Documents/Dropbox (Mixta)/Sites/m2l/app/cache/dev/doctrine/orm/Proxies',
